...
const visitContent = {
  ...
  cards: [
    ...
    { title: '면회 시 준비사항', desc: '■ 입장 절차\n① 보호자 신분증 + 아기 발찌를 에스텍 직원에게 확인\n② 앞 면회기록지에 이름·시간 등 작성\n③ 전실 입장 후 슈즈커버 착용\n④ 손 위생 + 휴대폰 닦기 후 입장\n\n■ 면회복·향기\n▸ 면회복(가운) 착용 — NICU 입구에서 제공\n▸ 향수·화장품 등 강한 향 자제\n▸ 귀중품은 어린이병원 5층 엘리베이터 옆 보호자 사물함에 보관 후 입실\n\n■ 아기와의 접촉 순서\n아기에게 들어가면 먼저 touch(피부 접촉)를 해주세요.\n휴대폰으로 사진 촬영은 touch 후 남은 시간에 해주세요.\n(감염 예방을 위해 휴대폰은 최대한 나중에 사용해 주세요.)\n\n■ Touch 제한 안내\n• 외부 입원 환아는 균 검사 결과가 나오기 전까지 예방적으로 touch가 불가합니다.\n• 아기의 상태에 따라 touch가 제한될 수 있습니다.\n  양해해 주셔서 감사합니다.', icon: ShieldCheck },
